...
function getOrderByIdTK($idTK){
    ...
    MIN(donhang.trangthai) AS trangthaiDH,
    MIN(sach.trangthai) AS trangthaiSach, 
    MIN(hinhanh) AS hinhanh, 
    MIN(tuasach) AS tuasach, 
    MIN(tacgia) AS tacgia, 
    MIN(soluong) AS soluong, 
    MIN(gialucdat) AS gialucdat, 
    MIN(tongtien) AS tongtien 
