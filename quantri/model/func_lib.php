<?php
    ...
    function getGRNTotal($dateStart, $dateEnd) {
        $sql = "SELECT SUM(pn.tongtien) as tongtiennhap
                ...
                WHERE	pn.trangthai = 'ht'
                    AND	pn.ngaytao BETWEEN '".$dateStart."' AND '".$dateEnd."'";
        $result = getOne($sql)['tongtiennhap'];
        if($result == null) return 0;
        return $result;
    }
